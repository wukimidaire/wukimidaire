...
- **Save The Crops**: A computer vision project to identify plant diseases from leaf images.
...
- **Postgres Table Templates Framework**: A versatile boilerplate database collection designed for multiple applications.
  - **Applications**:
